  ...
  const navSections: { titleKey: string; items: NavItem[] }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/mcp-router", labelKey: "mcpRouter", icon: <Route size={18} aria-hidden="true" />, children: [
          { href: "/mcp-router", labelKey: "mcpRouterDashboard" },
          { href: "/mcp-router/metrics", labelKey: "mcpRouterMetrics" },
          { href: "/mcp-router/sessions", labelKey: "mcpRouterSessions" },
        ] },
